...
#define PORT_AR_RELEASE_MAJOR_VERSION     21
#define PORT_AR_RELEASE_MINOR_VERSION     11
...
#if (PORT_VENDOR_ID != PORT_HW_VENDOR_ID_H)
...
#if ((PORT_AR_RELEASE_MAJOR_VERSION    != PORT_HW_AR_RELEASE_MAJOR_VERSION_H) || \
     (PORT_AR_RELEASE_MINOR_VERSION    != PORT_HW_AR_RELEASE_MINOR_VERSION_H) || \
     (PORT_AR_RELEASE_REVISION_VERSION != PORT_HW_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((PORT_SW_MAJOR_VERSION != PORT_HW_SW_MAJOR_VERSION_H) || \
     (PORT_SW_MINOR_VERSION != PORT_HW_SW_MINOR_VERSION_H) || \
     (PORT_SW_PATCH_VERSION != PORT_HW_SW_PATCH_VERSION_H)    \
    )
