...
#define PORT_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG_C        21
#define PORT_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_C        11
#define PORT_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_C     0
#define PORT_SW_MAJOR_VERSION_VS_0_PBCFG_C                1
...
*/
const Port_ConfigType Port_Config_VS_0 =
{
	...
	PortHw_g_Pin_Mux_InitConfigArr_VS_0
};
