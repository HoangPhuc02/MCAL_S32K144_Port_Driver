...
#define PORT_CFG_AR_RELEASE_MAJOR_VERSION_H        21
#define PORT_CFG_AR_RELEASE_MINOR_VERSION_H        11
...
#if (PORT_CFG_VENDOR_ID_H != PORT_HW_TYPES_VENDOR_ID_H)
...
#if ((PORT_CFG_AR_RELEASE_MAJOR_VERSION_H != PORT_HW_TYPES_AR_RELEASE_MAJOR_VERSION_H) ||   \
     (PORT_CFG_AR_RELEASE_MINOR_VERSION_H != PORT_HW_TYPES_AR_RELEASE_MINOR_VERSION_H) ||   \
     (PORT_CFG_AR_RELEASE_REVISION_VERSION_H != PORT_HW_TYPES_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((PORT_CFG_SW_MAJOR_VERSION_H != PORT_HW_TYPES_SW_MAJOR_VERSION_H) || \
     (PORT_CFG_SW_MINOR_VERSION_H != PORT_HW_TYPES_SW_MINOR_VERSION_H) || \
     (PORT_CFG_SW_PATCH_VERSION_H != PORT_HW_TYPES_SW_PATCH_VERSION_H)     \
    )
