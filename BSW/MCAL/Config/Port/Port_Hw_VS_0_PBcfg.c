...
#define PORT_CI_PORT_IP_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_C        4
#define PORT_CI_PORT_IP_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_C     0
#define PORT_CI_PORT_IP_SW_MAJOR_VERSION_VS_0_PBCFG_C                1
#define PORT_CI_PORT_IP_SW_MINOR_VERSION_VS_0_PBCFG_C                0
#define PORT_CI_PORT_IP_SW_PATCH_VERSION_VS_0_PBCFG_C                1
...
const PortHw_PinSettingsConfigType g_pin_mux_InitConfigArr_VS_0[NUM_OF_CONFIGURED_PINS] = 
{
    {
        .PortBase_ptr              = PORTD,
        .GpioBase_ptr              = PTD,
