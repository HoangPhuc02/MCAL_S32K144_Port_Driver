...
#define PORT_TYPES_AR_RELEASE_MAJOR_VERSION_H        4
#define PORT_TYPES_AR_RELEASE_MINOR_VERSION_H        4
...
#define PORT_TYPES_SW_PATCH_VERSION_H                1
...
/* NEW */
/**
* @brief Parameter to indicate if the direction is changeable on a port pin during runtime.
* @details true: Port Pin direction changeable enabled. 
*          false: Port Pin direction changeable disabled.
* @implements Port_PinDirectionChangeable_boolean
*/
