...
void Mcu_SetPeriClk(void)
{
	IP_PCC-> PCCn[PCC_PORTA_INDEX] = PCC_PCCn_CGC_MASK;/* Enable clock to PORT A*/
	IP_PCC-> PCCn[PCC_PORTB_INDEX] = PCC_PCCn_CGC_MASK;/* Enable clock to PORT B*/
	...
	IP_PCC-> PCCn[PCC_PORTE_INDEX] = PCC_PCCn_CGC_MASK;/* Enable clock to PORT E*/
}
